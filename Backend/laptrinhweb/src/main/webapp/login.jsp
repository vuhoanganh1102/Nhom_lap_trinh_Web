            ...
            <div action="" class="login__form">
                <div class="login__heading">
                    ...
                    <p class="login__description">
                        ...
                        <a href="sign-up.jsp" class="btn__register">Đăng ký tại đây.</a>
                    </p>
                </div>
                <form class="user" action="login" method="post">
                    ...
                    <div class="login__inputs">
                        <div>
                            <label for="username" class="login__label">Email
                                <span class="input__required">*</span>
                            </label>
                            <input type="email" placeholder="Email" name="username" required id="username" class="login__input">
                        </div>
                        <div>
                            <label for="password" class="login__label">Mật khẩu
                                <span class="input__required">*</span>
                            </label>
                    ...
                    <div class="login__forget">
                        <p>Quên mật khẩu? Nhấn vào
                            <a class="small" th:href = "@{/forgot-password}">đây</a>
                        </p>
                    </div>
